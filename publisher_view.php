...
if(isset($_POST['update_magazine']))
{
   ...
   if(!empty($image)){
      mysqli_query($cn, "UPDATE `magazines` SET M_Image = '$image' WHERE Magazine_Id = '$id'") or die('query failed');
   }  
...
?>
         ...
         <img src="images/<?php echo $row['M_Image']; ?>" height="" alt=""></a>
         <div class="card-content">
            <h1><?php echo $row['Magazine_Name']; ?><br></h1>
            
            <h3><?php echo $row['Author']; ?><h3><br>
            <p><?php echo $row['Category']; ?><br>
            <?php echo $row['Language']; ?><br>
            Rs.<?php echo $row['Price']; ?><br>
            <?php echo $row['Description']; ?><p><br>
            <td>
               <a style = "color: black"  href="publisher_view.php?update=<?php echo $row['Magazine_Id']; ?>" class="option-btn"><i class="glyphicon glyphicon-pencil"></i> update</a><br><br>
