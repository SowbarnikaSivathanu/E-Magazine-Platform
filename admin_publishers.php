...
<br><br><br><br>
<h1 class="title" style ="color: white"> Publishers Details</h1><br>
<table class="container">
      <thead>
         <th><h1>Publisher id</h1></th>
         <th><h1>Publisher name</h1></th>
         <th><h1>Publisher email id</h1></th>
         <th><h1>Publisher type</h1></th>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td id="remove">
            <a href="admin_publishers.php?delete=<?php echo $row['User_Id']; ?>" onclick="return confirm('delete this user?');" class="delete-btn" id="remove"><i class="fas fa-trash"></i> remove user</a>
         </td>
         </tr>
